...
function check() {
  ...
  if(inputMatric === user.mactricNo && Number(inputPass) === user.password) {
    var show = document.getElementById('show').textContent = msg1;
  } else{
    var show = document.getElementById('show').textContent = msg2;
  }
}